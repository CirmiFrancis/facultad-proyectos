 ...
 * MA 02110-1301, USA.
 * 
 * escritor cola de mensajes no bloqueante y trunca mensaje para llenar
 * por completo la cola de mensajes
 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
int main(int argc, char **argv) {
	...
	do {
		...
		ret = msgsnd(cola,&m,sizeof(t_venta),IPC_NOWAIT|MSG_NOERROR); // msgsnd NO bloqueante, 4to argumento IPC_NOWAIT
		n++;
