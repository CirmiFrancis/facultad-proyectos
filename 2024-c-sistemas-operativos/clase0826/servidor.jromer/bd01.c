...
int main(void)
{
   ...
   printf("Acceso a bases de datos PostgreSql<br>\n"); 
   printf("---------------------------------------<br>\n");
   printf("<HTML><BODY>\n");
   printf("<form method=\"POST\" action=\"bd001.cgi\">\n");
   printf("<INPUT TYPE=\"HIDDEN\" ID=\"MISDATOS\" NAME=\"MISDATOS\" VALUE=\"SI\"/> SGBD  Postgresql<br>\n");

   printf("<label for=\"USERNAME\">Ingrese usuario:</label>\n");
   printf("<INPUT TYPE=\"text\" id=\"USERNAME\" NAME=\"USERNAME\"><br>\n");

   printf("<label for=\"USERPASS\">Ingrese contraseña:</label>\n");      
  ...
  printf("<INPUT TYPE=\"CHECKBOX\" ID=\"VERTAB\" NAME=\"VERTAB\" VALUE=\"SI\"/> <br>\n");
   ...
   printf("<label for=\"VERTAB\">Ingrese el nombre de una BD de usuario:</label>\n");      
